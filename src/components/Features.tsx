  ...
  const features = [
    {
      ...
      description: 'Full TypeScript support with type checking and IntelliSense.',
      icon: (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:text-center">
          ...
          <p className="mt-4 max-w-2xl text-xl text-gray-500 dark:text-gray-300 lg:mx-auto">
            A carefully crafted starter project with all the essential features for modern web development.
          </p>
        </div>
