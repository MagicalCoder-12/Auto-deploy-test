    ...
    <footer className="bg-white dark:bg-gray-800">
      <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
        ...
        <div className="mt-8 flex justify-center space-x-6">
          {[0, 1, 2].map((item) => (
            <a key={item} href="#" className="text-gray-400 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-200">
        ...
        <p className="mt-8 text-center text-base text-gray-400 dark:text-gray-300">
          &copy; 2025 Vite + React Starter. All rights reserved.
        </p>
      </div>
    </footer>
  )
